...
#include "SigilAbilityTask_WaitInputPressWithTags.generated.h"
 ...
 */
UCLASS()
class SIGILGAS_API USigilAbilityTask_WaitInputPressWithTags : public UAbilityTask
{
	...
	*/
	...
	static USigilAbilityTask_WaitInputPressWithTags* WaitInputPressWithTags(UGameplayAbility* OwningAbility, FGameplayTagContainer RequiredTags, FGameplayTagContainer IgnoredTags, bool bTestAlreadyPressed = false);
