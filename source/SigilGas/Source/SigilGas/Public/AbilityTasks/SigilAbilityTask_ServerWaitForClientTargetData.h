...
#include "SigilAbilityTask_ServerWaitForClientTargetData.generated.h"


UCLASS()
class SIGILGAS_API USigilAbilityTask_ServerWaitForClientTargetData : public UAbilityTask
{
	...
	static USigilAbilityTask_ServerWaitForClientTargetData* ServerWaitForClientTargetData(UGameplayAbility* OwningAbility, FName TaskInstanceName, bool TriggerOnce);
