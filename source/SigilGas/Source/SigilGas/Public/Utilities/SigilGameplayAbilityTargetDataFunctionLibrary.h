...
#include "SigilGameplayAbilityTargetDataFunctionLibrary.generated.h"
 ...
 */
UCLASS()
class SIGILGAS_API USigilGameplayAbilityTargetDataFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
