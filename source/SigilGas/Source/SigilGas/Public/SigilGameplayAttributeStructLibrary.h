...
#include "SigilGameplayAttributeStructLibrary.generated.h"

USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilModifiedAttribute
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilGameplayEffectModCallbackData
{
	GENERATED_BODY()
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "GGA")
	TArray<FSigilModifiedAttribute> ModifiedAttributes;
