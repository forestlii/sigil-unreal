...
#include "SigilGameplayAttributesHelper.generated.h"

/**
 * 
 */
UCLASS(meta=(DisplayName="GGA Gameplay Attribute Function Library"))
class SIGILGAS_API USigilGameplayAttributesHelper : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static float GetModifiedAttributeMagnitude(const TArray<FSigilModifiedAttribute>& ModifiedAttributes, FGameplayAttribute InAttribute);
