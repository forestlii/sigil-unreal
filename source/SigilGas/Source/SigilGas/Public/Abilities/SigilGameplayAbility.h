 ...
 */
UCLASS(Abstract)
class SIGILGAS_API USigilGameplayAbility : public UGameplayAbility, public FTickableGameObject, public ISigilGameplayAbilityInterface
{
	GENERATED_BODY()
...
public:
	 ...
	 * 游戏技能构造函数。
	 */
	USigilGameplayAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	 ...
	 */
	virtual ESigilAbilityActivationGroup GetActivationGroup() const override { return ActivationGroup; }
	 ...
	 */
	virtual void SetActivationGroup(ESigilAbilityActivationGroup NewGroup) override;
	...
	virtual FSigilGameplayEffectContainerSpec MakeEffectContainerSpec(FGameplayTag ContainerTag, const FGameplayEventData& EventData, int32 OverrideGameplayLevel = -1);
...
protected:
	...
	ESigilAbilityActivationGroup ActivationGroup;
	...
	TArray<TObjectPtr<USigilAbilityCost>> AdditionalCosts;
	...
	TArray<FSigilGameplayTagCount> ActivationOwnedLooseTags;
	...
	TMap<FGameplayTag, FSigilGameplayEffectContainer> EffectContainerMap;
