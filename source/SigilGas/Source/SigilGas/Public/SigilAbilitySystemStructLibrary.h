...
#include "SigilAbilitySystemStructLibrary.generated.h"
...
struct SIGILGAS_API FSigilAttributeGroupName
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilGameplayTagCount
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilGameplayTagArray
{
	GENERATED_BODY()
	 ...
	 */
	FORCEINLINE static FSigilGameplayTagArray CreateFromContainer(const FGameplayTagContainer& Container)
	{
		FSigilGameplayTagArray TagArray;
 ...
 */
USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilGameplayEffectArray
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilGameplayEffectContainer
{
	GENERATED_BODY()

public:
	FSigilGameplayEffectContainer() {}
 ...
 */
USTRUCT(BlueprintType)
struct SIGILGAS_API FSigilGameplayEffectContainerSpec
{
	GENERATED_BODY()

public:
	FSigilGameplayEffectContainerSpec() {}
