...
#include "SigilAbilityTargetActor_Trace.h"
#include "DrawDebugHelpers.h"
#include "SigilAbilityTargetActor_SphereTrace.generated.h"
 ...
 */
UCLASS()
class SIGILGAS_API ASigilAbilityTargetActor_SphereTrace : public ASigilAbilityTargetActor_Trace
{
	GENERATED_BODY()

public:
	ASigilAbilityTargetActor_SphereTrace();
