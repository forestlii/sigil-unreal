...
#include "SigilStaminaSet.generated.h"

namespace SigilStaminaSet
{
	
	SIGILGAS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stamina)
	
	SIGILGAS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MaxStamina)
	
	
	SIGILGAS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(IncomingHealing)
	
	SIGILGAS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(IncomingDamage)
...
UCLASS()
class SIGILGAS_API USigilStaminaSet : public UAttributeSet
{
	GENERATED_BODY()
