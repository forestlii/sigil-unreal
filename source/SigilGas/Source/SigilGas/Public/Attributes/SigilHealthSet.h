...
#include "SigilHealthSet.generated.h"

namespace SigilHealthSet
{
	
	SIGILGAS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Health)
	
	SIGILGAS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MaxHealth)
...
UCLASS()
class SIGILGAS_API USigilHealthSet : public UAttributeSet
{
	GENERATED_BODY()
