...
ASigilAbilityTargetActor_Trace::ASigilAbilityTargetActor_Trace()
{
...
void ASigilAbilityTargetActor_Trace::ResetSpread()
{
	bUseAimingSpreadMod = false;
	BaseSpread = 0.0f;
	AimingSpreadMod = 0.0f;
...
void ASigilAbilityTargetActor_Trace::SetStartLocation(const FGameplayAbilityTargetingLocationInfo& InStartLocation)
{
	StartLocation = InStartLocation;
}

void ASigilAbilityTargetActor_Trace::SetShouldProduceTargetDataOnServer(bool bInShouldProduceTargetDataOnServer)
{
	ShouldProduceTargetDataOnServer = bInShouldProduceTargetDataOnServer;
}

void ASigilAbilityTargetActor_Trace::SetDestroyOnConfirmation(bool bInDestroyOnConfirmation)
{
	bDestroyOnConfirmation = bInDestroyOnConfirmation;
}

void ASigilAbilityTargetActor_Trace::StartTargeting(UGameplayAbility* Ability)
{
...
void ASigilAbilityTargetActor_Trace::ConfirmTargetingAndContinue()
{
...
void ASigilAbilityTargetActor_Trace::CancelTargeting()
{
...
void ASigilAbilityTargetActor_Trace::BeginPlay()
{
	Super::BeginPlay();
...
void ASigilAbilityTargetActor_Trace::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	DestroyReticleActors();
...
void ASigilAbilityTargetActor_Trace::Tick(float DeltaSeconds)
{
...
void ASigilAbilityTargetActor_Trace::LineTraceWithFilter(TArray<FHitResult>& OutHitResults, const UWorld* World,
...
void ASigilAbilityTargetActor_Trace::AimWithPlayerController(const AActor* InSourceActor, FCollisionQueryParams Params,
...
void ASigilAbilityTargetActor_Trace::StopTargeting()
{
	SetActorTickEnabled(false);
...
FGameplayAbilityTargetDataHandle ASigilAbilityTargetActor_Trace::MakeTargetData(const TArray<FHitResult>& HitResults) const
{
...
TArray<FHitResult> ASigilAbilityTargetActor_Trace::PerformTrace(AActor* InSourceActor)
{
...
AGameplayAbilityWorldReticle* ASigilAbilityTargetActor_Trace::SpawnReticleActor(FVector Location, FRotator Rotation)
{
	if (ReticleClass)
	{
...
void ASigilAbilityTargetActor_Trace::DestroyReticleActors()
{
...
void ASigilAbilityTargetActor_Trace::GetCurrentHitResult(TArray<FHitResult>& HitResults)
{
