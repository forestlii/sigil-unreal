...
#include "TargetActors/SigilAbilityTargetActor_SphereTrace.h"
#include "WorldCollision.h"
#include "Engine/World.h"
#include "GameFramework/PlayerController.h"
#include "DrawDebugHelpers.h"

ASigilAbilityTargetActor_SphereTrace::ASigilAbilityTargetActor_SphereTrace()
{
	TraceSphereRadius = 100.0f;
}

void ASigilAbilityTargetActor_SphereTrace::Configure(
...
void ASigilAbilityTargetActor_SphereTrace::SphereTraceWithFilter(TArray<FHitResult>& OutHitResults, const UWorld* World,
...
void ASigilAbilityTargetActor_SphereTrace::DoTrace(TArray<FHitResult>& HitResults, const UWorld* World,
                                const FGameplayTargetDataFilterHandle FilterHandle, const FVector& Start,
...
void ASigilAbilityTargetActor_SphereTrace::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType,
                                       float Duration)
{
...
void ASigilAbilityTargetActor_SphereTrace::DrawDebugSweptSphere(const UWorld* InWorld, FVector const& Start, FVector const& End,
...
void ASigilAbilityTargetActor_SphereTrace::DrawDebugSphereTraceMulti(const UWorld* World, const FVector& Start, const FVector& End,
