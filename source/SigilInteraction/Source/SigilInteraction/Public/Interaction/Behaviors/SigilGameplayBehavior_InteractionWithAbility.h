...
#include "SigilGameplayBehavior_InteractionWithAbility.generated.h"
...
class SIGILINTERACTION_API USigilGameplayBehavior_InteractionWithAbility : public UGameplayBehavior
{
	GENERATED_BODY()
