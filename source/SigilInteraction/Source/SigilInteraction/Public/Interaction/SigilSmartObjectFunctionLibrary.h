...
#include "SigilSmartObjectFunctionLibrary.generated.h"
 ...
 */
UCLASS()
class SIGILINTERACTION_API USigilSmartObjectFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static bool FindInteractionDefinitionFromSmartObjectSlot(UObject* WorldContext, FSmartObjectSlotHandle SmartObjectSlotHandle, USigilInteractionDefinition*& OutDefinition);
};
