...
#include "SigilTargetingFilterTask_InteractionSmartObjects.generated.h"
...
class SIGILINTERACTION_API USigilTargetingFilterTask_InteractionSmartObjects : public UTargetingFilterTask_BasicFilterTemplate
{
	GENERATED_BODY()
