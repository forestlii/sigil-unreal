...
#include "SigilGameplayAbility_Interaction.generated.h"
...
class SIGILINTERACTION_API USigilGameplayAbility_Interaction : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	 ...
	 * 交互游戏技能构造函数。
	 */
	USigilGameplayAbility_Interaction();
...
protected:
	...
	TObjectPtr<USigilInteractionSystemComponent> InteractionSystem{nullptr};
