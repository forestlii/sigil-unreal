...
#include "CommonUserWidget.h"
#include "SigilSimulatedInputWidget.generated.h"
 ...
 */
UCLASS()
class SIGILUI_API USigilSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	USigilSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
