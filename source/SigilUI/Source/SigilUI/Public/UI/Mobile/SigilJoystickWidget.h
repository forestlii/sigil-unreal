...
#include "SigilJoystickWidget.generated.h"
 ...
 */
UCLASS()
class SIGILUI_API USigilJoystickWidget : public USigilSimulatedInputWidget
{
	GENERATED_BODY()

public:
	USigilJoystickWidget(const FObjectInitializer& ObjectInitializer);
