...
#include "SigilTileView.generated.h"
...
class SIGILUI_API USigilTileView : public UCommonTileView
{
	GENERATED_BODY()
...
public:
	 ...
	 * TileView小部件构造函数。
	 */
	USigilTileView(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
