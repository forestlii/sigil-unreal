...
#include "SigilGameUIStructLibrary.h"
#include "Engine/World.h"
#include "Engine/DataTable.h"
#include "SigilGameUIPolicy.generated.h"

class UCommonUserWidget;
class USigilGameUIContext;
class ULocalPlayer;
class USigilGameUISubsystem;
 ...
 */
UENUM()
enum class ESigilLocalMultiplayerInteractionMode : uint8
{
 ...
 */
UCLASS(Abstract, Blueprintable, Within = SigilGameUISubsystem)
class SIGILUI_API USigilGameUIPolicy : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	template <typename GameUIPolicyClass = USigilGameUIPolicy>
	 ...
	 */
	static USigilGameUIPolicy* GetGameUIPolicy(const UObject* WorldContextObject);
	 ...
	 */
	USigilGameUISubsystem* GetOwningSubsystem() const;
	 ...
	 */
	USigilGameUILayout* GetRootLayout(const ULocalPlayer* LocalPlayer) const;
	 ...
	 */
	virtual USigilGameUIContext* GetContext(const ULocalPlayer* LocalPlayer, TSubclassOf<USigilGameUIContext> ContextClass);
	 ...
	 */
	virtual bool AddContext(const ULocalPlayer* LocalPlayer, USigilGameUIContext* NewContext);
	 ...
	 */
	virtual USigilGameUIContext* FindContext(const ULocalPlayer* LocalPlayer, TSubclassOf<USigilGameUIContext> ContextClass);
	 ...
	 */
	virtual void RemoveContext(const ULocalPlayer* LocalPlayer, TSubclassOf<USigilGameUIContext> ContextClass);
	...
	virtual void AddUIAction(const ULocalPlayer* LocalPlayer, UCommonUserWidget* Target, const FDataTableRowHandle& InputAction, bool bShouldDisplayInActionBar,
	                         const FSigilUIActionExecutedDelegate& Callback,
	 ...
	 */
	virtual void RemoveUIAction(const ULocalPlayer* LocalPlayer, FSigilUIActionBindingHandle& BindingHandle);
	 ...
	 */
	ESigilLocalMultiplayerInteractionMode GetLocalMultiplayerInteractionMode() const { return LocalMultiplayerInteractionMode; }
	 ...
	 */
	void RequestPrimaryControl(USigilGameUILayout* Layout);
...
protected:
	 ...
	 */
	void AddLayoutToViewport(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	 ...
	 */
	void RemoveLayoutFromViewport(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	 ...
	 */
	virtual void OnRootLayoutAddedToViewport(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	...
	void BP_OnRootLayoutAddedToViewport(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	 ...
	 */
	virtual void OnRootLayoutRemovedFromViewport(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	...
	void BP_OnRootLayoutRemovedFromViewport(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	 ...
	 */
	virtual void OnRootLayoutReleased(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	...
	void BP_OnRootLayoutReleased(ULocalPlayer* LocalPlayer, USigilGameUILayout* Layout);
	 ...
	 */
	TSubclassOf<USigilGameUILayout> GetLayoutWidgetClass(ULocalPlayer* LocalPlayer);
...
private:
	 ...
	 * 当前的多人交互模式。
	 */
	ESigilLocalMultiplayerInteractionMode LocalMultiplayerInteractionMode = ESigilLocalMultiplayerInteractionMode::PrimaryOnly;
	...
	TSoftClassPtr<USigilGameUILayout> LayoutClass;
	 ...
	 */
	UPROPERTY(Transient)
	TArray<FSigilRootViewportLayoutInfo> RootViewportLayouts;
	...
	friend class USigilGameUISubsystem;
};
