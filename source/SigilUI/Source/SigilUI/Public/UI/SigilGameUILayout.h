...
#include "SigilGameUIFunctionLibrary.h"
#include "Widgets/CommonActivatableWidgetContainer.h" // IWYU pragma: keep

#include "SigilGameUILayout.generated.h"
 ...
 * 异步UI控件层加载操作状态的枚举。
 */
enum class ESigilAsyncWidgetLayerState : uint8
{
...
class SIGILUI_API USigilGameUILayout : public UCommonUserWidget
{
	GENERATED_BODY()
...
public:
	 ...
	 * 游戏UI布局的构造函数。
	 */
	USigilGameUILayout(const FObjectInitializer &ObjectInitializer);
...
public:
	...
	{
		return PushWidgetToLayerStackAsync<ActivatableWidgetT>(LayerName, bSuspendInputUntilComplete, ActivatableWidgetClass, [](ESigilAsyncWidgetLayerState, ActivatableWidgetT *) {});
	}
	...
	template <typename ActivatableWidgetT = UCommonActivatableWidget>
	TSharedPtr<FStreamableHandle> PushWidgetToLayerStackAsync(FGameplayTag LayerName, bool bSuspendInputUntilComplete, TSoftClassPtr<UCommonActivatableWidget> ActivatableWidgetClass,
															  TFunction<void(ESigilAsyncWidgetLayerState, ActivatableWidgetT *)> StateFunc)
	{
		static_assert(TIsDerivedFrom<ActivatableWidgetT, UCommonActivatableWidget>::IsDerived, "Only CommonActivatableWidgets can be used here");

		static FName NAME_PushingWidgetToLayer("PushingWidgetToLayer");
		const FName SuspendInputToken = bSuspendInputUntilComplete ? USigilGameUIFunctionLibrary::SuspendInputForPlayer(GetOwningPlayer(), NAME_PushingWidgetToLayer) : NAME_None;

		FStreamableManager &StreamableManager = UAssetManager::Get().GetStreamableManager();
		TSharedPtr<FStreamableHandle> StreamingHandle = StreamableManager.RequestAsyncLoad(ActivatableWidgetClass.ToSoftObjectPath(), FStreamableDelegate::CreateWeakLambda(this,
																																											[this, LayerName, ActivatableWidgetClass, StateFunc, SuspendInputToken]()
																																											{
																																												USigilGameUIFunctionLibrary::ResumeInputForPlayer(GetOwningPlayer(), SuspendInputToken);
																																												...
																																												ActivatableWidgetT *Widget = PushWidgetToLayerStack<ActivatableWidgetT>(
																																													...
																																													{ StateFunc(ESigilAsyncWidgetLayerState::Initialize, &WidgetToInit); });

																																												StateFunc(ESigilAsyncWidgetLayerState::AfterPush, Widget);
																																											}));
		...
		StreamingHandle->BindCancelDelegate(FStreamableDelegate::CreateWeakLambda(this,
																				  ...
																				  {
																					  USigilGameUIFunctionLibrary::ResumeInputForPlayer(GetOwningPlayer(), SuspendInputToken);
																					  StateFunc(ESigilAsyncWidgetLayerState::Canceled, nullptr);
																				  }));
...
protected:
	...
	void RegisterLayer(UPARAM(meta = (Categories = "Sigil.UI.Layer")) FGameplayTag LayerTag, UCommonActivatableWidgetContainerBase *LayerWidget);
...
private:
	 ...
	 * 主布局的注册层。
	 */
	UPROPERTY(Transient, meta = (Categories = "Sigil.UI.Layer"))
