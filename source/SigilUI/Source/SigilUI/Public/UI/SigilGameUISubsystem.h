...
#include "SigilGameUISubsystem.generated.h"
 ...
 */
UCLASS()
class SIGILUI_API USigilGameUISubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()

public:
	USigilGameUISubsystem()
	{
	}
	...
	const USigilGameUIPolicy* GetCurrentUIPolicy() const { return CurrentPolicy; }
	 ...
	 * @return The current UI policy. 当前UI策略。
	 */
	USigilGameUIPolicy* GetCurrentUIPolicy() { return CurrentPolicy; }
	...
	void RegisterUIActionBinding(UCommonUserWidget* Target, FDataTableRowHandle InputAction, bool bShouldDisplayInActionBar, const FSigilUIActionExecutedDelegate& Callback,
	...
	void UnregisterBinding(UPARAM(ref) FSigilUIActionBindingHandle& BindingHandle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GUIS")
	virtual void UnregisterUIActionBindingForPlayer(ULocalPlayer* LocalPlayer, UPARAM(ref) FSigilUIActionBindingHandle& BindingHandle);
	...
	void RegisterUIContextForPlayer(ULocalPlayer* LocalPlayer, USigilGameUIContext* Context, FSigilUIContextBindingHandle& BindingHandle);
	...
	void RegisterUIContextForActor(AActor* Actor, USigilGameUIContext* Context, FSigilUIContextBindingHandle& BindingHandle);
	...
	bool FindUIContextForPlayer(ULocalPlayer* LocalPlayer, TSubclassOf<USigilGameUIContext> ContextClass, USigilGameUIContext*& OutContext);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GUIS", meta=(DefaultToSelf="LocalPlayer", DeterminesOutputType="ContextClass", DynamicOutputParam="OutContext", ExpandBoolAsExecs="ReturnValue"))
	bool FindUIContextFromHandle(UPARAM(ref) FSigilUIContextBindingHandle& BindingHandle, TSubclassOf<USigilGameUIContext> ContextClass, USigilGameUIContext*& OutContext);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GUIS", meta=(DefaultToSelf="LocalPlayer"))
	void UnregisterUIContextForPlayer(UPARAM(ref) FSigilUIContextBindingHandle& BindingHandle);
...
protected:
	 ...
	 */
	void SwitchToPolicy(USigilGameUIPolicy* InPolicy);
...
private:
	 ...
	 */
	UPROPERTY(Transient)
	TObjectPtr<USigilGameUIPolicy> CurrentPolicy = nullptr;
