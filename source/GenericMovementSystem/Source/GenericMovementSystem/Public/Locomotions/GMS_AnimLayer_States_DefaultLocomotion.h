...
#include "GMS_AnimLayer_States.h"
#include "GMS_AnimState.h"
#include "Animation/AnimExecutionContext.h"
#include "Animation/AnimNodeReference.h"
#include "GMS_AnimLayer_States_DefaultLocomotion.generated.h"

#pragma region Settings

USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Jump : public FGMS_AnimData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Idle : public FGMS_AnimData
{
	GENERATED_BODY()
...
UENUM(BlueprintType)
enum class EGMS_StartAnimType_ViewDir : uint8
{
	Direction_4,
	Direction_8,
};
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Start_ViewDirection : public FGMS_AnimData
{
	GENERATED_BODY()
	 ...
	 */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="GMS")
	EGMS_StartAnimType_ViewDir AnimType{EGMS_StartAnimType_ViewDir::Direction_4};

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="GMS", meta=(EditCondition="AnimType==EGMS_StartAnimType_ViewDir::Direction_4", EditConditionHides))
	FGMS_Animations_4Direction Animations;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="GMS", meta=(EditCondition="AnimType==EGMS_StartAnimType_ViewDir::Direction_8", EditConditionHides))
	FGMS_Animations_8Direction Animations_8Direction;
...
UENUM(BlueprintType)
enum class EGMS_StartAnimType_VelocityDir : uint8
{
	Reface,
	Single,
};
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Start_VelocityDirection : public FGMS_AnimData
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS")
	EGMS_StartAnimType_VelocityDir AnimType{EGMS_StartAnimType_VelocityDir::Reface};

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="AnimType==EGMS_StartAnimType_VelocityDir::Reface", EditConditionHides))
	FGMS_Animations_StartForwardFacing Animations;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="AnimType==EGMS_StartAnimType_VelocityDir::Single", EditConditionHides))
...
UENUM(BlueprintType)
enum class EGMS_CycleAnimType : uint8
{
	Direction_4,
	Direction_8,
	Single,
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Cycle : public FGMS_AnimData
{
	GENERATED_BODY()
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS")
	EGMS_CycleAnimType AnimType{EGMS_CycleAnimType::Direction_4};

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="GMS", meta=(EditCondition="AnimType==EGMS_CycleAnimType::Direction_4", EditConditionHides))
	FGMS_Animations_4Direction Animations;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="GMS", meta=(EditCondition="AnimType==EGMS_CycleAnimType::Direction_8", EditConditionHides))
	FGMS_Animations_8Direction Animations_8Direction;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="GMS", meta=(EditCondition="AnimType==EGMS_CycleAnimType::Single", EditConditionHides))
	TObjectPtr<UAnimSequence> Animation;
...
UENUM(BlueprintType)
enum class EGMS_StopAnimType : uint8
{
	Direction_4,
	Direction_8,
	Single,
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Stop : public FGMS_AnimData
{
	GENERATED_BODY()
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS")
	EGMS_StopAnimType AnimType{EGMS_StopAnimType::Direction_4};

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="AnimType==EGMS_StopAnimType::Direction_4", EditConditionHides))
	FGMS_Animations_4Direction Animations;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="AnimType==EGMS_StopAnimType::Single", EditConditionHides))
	TObjectPtr<UAnimSequence> Animation;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="AnimType==EGMS_StopAnimType::Direction_8", EditConditionHides))
	FGMS_Animations_8Direction Animations_8Direction;
};

USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Pivot : public FGMS_AnimData
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Land : public FGMS_AnimData
{
	GENERATED_BODY()
	...
	TArray<FGMS_AnimationWithDistance> Lands;
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_Lean : public FGMS_AnimData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_TurnInPlace : public FGMS_AnimData
{
	GENERATED_BODY()
...
struct GENERICMOVEMENTSYSTEM_API FGMS_AnimData_MovingStates
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, Category="GMS", meta=(Categories="GMS.MovementState"))
	FGameplayTag Tag;

	UPROPERTY(EditAnywhere, Category="GMS", meta=(DisplayName="Start(ViewDirection)", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Start_ViewDirection"))
	FInstancedStruct Start_ViewDir_Inst;

	UPROPERTY(EditAnywhere, Category="GMS", meta=(DisplayName="Start(VelocityDirection)", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Start_VelocityDirection"))
	FInstancedStruct Start_VelocityDir_Inst;

	UPROPERTY(EditAnywhere, Category="GMS", meta=(DisplayName="Cycle", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Cycle"))
	FInstancedStruct Cycle_Inst;

	UPROPERTY(EditAnywhere, Category="GMS", meta=(DisplayName="Stop", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Stop"))
	FInstancedStruct Stop_Inst;

	UPROPERTY(EditAnywhere, Category="GMS", meta=(DisplayName="Pivot", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Pivot"))
...
class GENERICMOVEMENTSYSTEM_API UGMS_AnimLayerSetting_States_Default : public UGMS_AnimLayerSetting_States
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="Anim States", meta=(DisplayName="Idle/IdleBreaks", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Idle"))
	FInstancedStruct Idle_Inst;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="Anim States", meta=(DisplayName="Jump/Fall", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Jump"))
	FInstancedStruct Jump_Inst;

	UPROPERTY(EditAnywhere, Category="Anim States", meta=(DisplayName="Land", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Land"))
	FInstancedStruct Land_Inst;

	UPROPERTY(EditAnywhere, Category="Anim States", meta=(DisplayName="Turn", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_TurnInPlace"))
	FInstancedStruct Turn_Inst;

	UPROPERTY(EditAnywhere, Category="Anim States", meta=(DisplayName="Lean", BaseStruct = "/Script/GenericMovementSystem.GMS_AnimData_Lean"))
	FInstancedStruct Lean_Inst;

	UPROPERTY(EditAnywhere, Category="Anim States", meta = (TitleProperty="Tag"))
	TArray<FGMS_AnimData_MovingStates> MovingStates;

	UPROPERTY(VisibleAnywhere, Category="Anim States", meta=(EditCondition=false, EditConditionHides))
	TMap<FGameplayTag, FGMS_AnimData_MovingStates> AcceleratedMovingStates;
 ...
 */
UCLASS(Abstract)
class GENERICMOVEMENTSYSTEM_API UGMS_AnimLayer_States_DefaultLocomotion : public UGMS_AnimLayer
{
	GENERATED_BODY()

	friend UGMS_AnimLayerSetting_States_Default;

#pragma region States

protected:
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Settings")
	TObjectPtr<const UGMS_AnimLayerSetting_States_Default> Setting;

	UPROPERTY()
	FGMS_AnimData_MovingStates AnimData_MovingStates;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Settings")
	FGMS_OrientationWarpingSettings OWSettings;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Idle AnimData_Idle;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_TurnInPlace AnimData_TurnInPlace;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Start_ViewDirection AnimData_Start_ViewDirection;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Start_VelocityDirection AnimData_Start_VelocityDirection;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Cycle AnimData_Cycle;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Lean AnimData_GroundedLean;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Stop AnimData_Stop;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Pivot AnimData_Pivot;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Jump AnimData_Jump;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Settings")
	FGMS_AnimData_Land AnimData_Land;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_Idle IdleState;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_Start StartState;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_Cycle CycleState;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_Stop StopState;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_Pivot PivotState;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_TurnInPlace TurnInPlaceState;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="State")
	FGMS_AnimState_IdleBreak IdleBreakState;
...
public:
	UGMS_AnimLayer_States_DefaultLocomotion();
...
public:
	...
	const FGMS_ViewDirectionSetting& GetViewDirectionSetting() const;
	const FGMS_VelocityDirectionSetting& GetVelocityDirectionSetting() const;
...
protected:
	...
	const FGMS_StrideWarpingSettings& GetStartStrideWarpingSettings() const;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="GMS|Animation", meta=(BlueprintThreadSafe))
	const FGMS_SteeringSettings& GetStartSteeringSettings() const;
