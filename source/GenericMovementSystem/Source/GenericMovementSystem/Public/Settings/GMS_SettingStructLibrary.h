...
class UGMS_MovementControlSetting;
 ...
 */
USTRUCT(BlueprintType)
struct FGMS_ViewDirectionSetting
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS")
	EGMS_ViewDirectionMode DirectionMode{EGMS_ViewDirectionMode::Default};
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="DirectionMode==EGMS_ViewDirectionMode::Aiming", EditConditionHides))
 ...
 */
USTRUCT(BlueprintType)
struct FGMS_VelocityDirectionSetting
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS")
	EGMS_VelocityDirectionMode DirectionMode{EGMS_VelocityDirectionMode::OrientToLastVelocityDirection};
	...
	// angle/s
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GMS", meta=(EditCondition="DirectionMode==EGMS_VelocityDirectionMode::TurningCircle", EditConditionHides))
 ...
 */
USTRUCT(BlueprintType)
struct FGMS_MovementStateSetting
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FGMS_MovementSetSetting
{
	GENERATED_BODY()
	...
	TObjectPtr<const UGMS_AnimLayerSetting_States> DA_AnimLayerSetting_States;
	...
	TObjectPtr<const UGMS_AnimLayerSetting_Overlay> DA_AnimLayerSetting_Overlay;
	...
	/**
	 * You can subclass from GMS_MovementSetUserSetting to create different custom setting.
	 ...
	 * 你可以通过集成GMS_MovementSetUserSetting来创建自定义设置。
