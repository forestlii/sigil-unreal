...
#include "Targeting/Filters/SigilTargetingFilterTask_TagsRequirements.h"

#include "AbilitySystemComponent.h"
#include "AbilitySystemGlobals.h"

bool USigilTargetingFilterTask_TagsRequirements::ShouldFilterTarget(const FTargetingRequestHandle& TargetingHandle, const FTargetingDefaultResultData& TargetData) const
{
