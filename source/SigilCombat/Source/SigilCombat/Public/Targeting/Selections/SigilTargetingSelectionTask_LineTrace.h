...
#include "SigilTargetingSelectionTask_LineTrace.generated.h"
...
/**
*	@class USigilTargetingSelectionTask_LineTrace
...
class SIGILCOMBAT_API USigilTargetingSelectionTask_LineTrace : public UTargetingTask
{
	GENERATED_BODY()

public:
	USigilTargetingSelectionTask_LineTrace(const FObjectInitializer& ObjectInitializer);
