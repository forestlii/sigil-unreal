...
#include "SigilTargetingFilterTask_Affiliation.generated.h"
...
class SIGILCOMBAT_API USigilTargetingFilterTask_Affiliation : public UTargetingFilterTask_BasicFilterTemplate
{
	GENERATED_BODY()
