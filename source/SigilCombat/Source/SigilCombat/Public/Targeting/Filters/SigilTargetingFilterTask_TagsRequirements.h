...
#include "SigilTargetingFilterTask_TagsRequirements.generated.h"
...
class SIGILCOMBAT_API USigilTargetingFilterTask_TagsRequirements : public UTargetingFilterTask_BasicFilterTemplate
{
	GENERATED_BODY()
