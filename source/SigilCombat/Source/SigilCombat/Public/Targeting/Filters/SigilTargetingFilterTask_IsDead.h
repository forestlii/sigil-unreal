...
#include "SigilTargetingFilterTask_IsDead.generated.h"
...
class SIGILCOMBAT_API USigilTargetingFilterTask_IsDead : public UTargetingFilterTask_BasicFilterTemplate
{
	GENERATED_BODY()
