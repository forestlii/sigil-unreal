...
#include "SigilBulletSubsystem.generated.h"

class USigilAttackRequest_Bullet;
class ASigilBulletInstance;
...
struct SIGILCOMBAT_API FSigilBulletSpawnParameters
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCS")
	TObjectPtr<const USigilAttackRequest_Bullet> Request{nullptr};
 ...
 */
UCLASS()
class SIGILCOMBAT_API USigilBulletSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
public:
	...
	virtual TArray<ASigilBulletInstance*> SpawnBullets(const FSigilBulletSpawnParameters& SpawnParameters);
	...
	virtual TArray<FGuid> GetIdsFromBullets(TArray<ASigilBulletInstance*> Instances);
	 ...
	 */
	TArray<ASigilBulletInstance*> GetOrCreateBulletInstances(const FSigilBulletSpawnParameters& SpawnParameters, const FSigilBulletDefinition& Definition);
	 ...
	 */
	ASigilBulletInstance* TakeBulletFromPool(TSubclassOf<ASigilBulletInstance> BulletClass);
	 ...
	 */
	ASigilBulletInstance* CreateBulletInstance(const FSigilBulletSpawnParameters& SpawnParameters, const FSigilBulletDefinition& Definition);
	...
	virtual bool LoadBulletDefinition(const FDataTableRowHandle& Handle, FSigilBulletDefinition& OutDefinition);
	 ...
	 */
	UPROPERTY()
	TMap<FGuid, TObjectPtr<ASigilBulletInstance>> BulletInstances;
	 ...
	 */
	UPROPERTY()
	TArray<TObjectPtr<ASigilBulletInstance>> BulletPools;
};