...
#include "SigilBulletDefinition.generated.h"
...
struct SIGILCOMBAT_API FSigilBulletDefinition : public FTableRowBase
{
	GENERATED_BODY()
	...
	TSoftClassPtr<ASigilBulletInstance> BulletActorClass;
	 ...
	 * 子弹的攻击定义句柄。
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Attack", meta=(RowType="/Script/SigilCombat.SigilAttackDefinition"))
	 ...
	 * @注意 不能与此子弹相同。
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Hit Configuration", meta=(RowType="/Script/SigilCombat.SigilBulletDefinition"))
	 ...
	 * 子弹链的发射条件。
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Hit Configuration", meta=(Categories="Sigil.Combat.Bullet.LaunchCond"))
	 ...
	 * 扩展子弹定义的自定义用户设置。
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Extension", meta=(ForceInlineRow, BaseStruct = "/Script/SigilCombat.SigilUserSetting"))
