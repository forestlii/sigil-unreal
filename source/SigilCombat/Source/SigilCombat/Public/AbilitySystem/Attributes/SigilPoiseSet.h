...
#include "SigilPoiseSet.generated.h"

namespace SigilPoiseSet
{
	
	SIGILCOMBAT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Poise)
	
	SIGILCOMBAT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MaxPoise)
	
	SIGILCOMBAT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PoiseRecover)
...
UCLASS()
class SIGILCOMBAT_API USigilPoiseSet : public UAttributeSet
{
	GENERATED_BODY()
