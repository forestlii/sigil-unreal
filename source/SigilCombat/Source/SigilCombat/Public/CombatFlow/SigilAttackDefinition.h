...
#endif
#include "SigilAttackDefinition.generated.h"
...
struct SIGILCOMBAT_API FSigilAttackDefinition : public FTableRowBase
{
	GENERATED_BODY()
	...
	FSigilGameplayEffectContainer TargetEffectContainer;
