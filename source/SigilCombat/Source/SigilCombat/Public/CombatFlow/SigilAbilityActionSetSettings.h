...
#include "SigilAbilityActionSetSettings.generated.h"
...
class SIGILCOMBAT_API USigilAbilityActionSetSettings : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	bool SelectBestAbilityActions(const FGameplayTagContainer& SourceTags, const FGameplayTagContainer& TargetTags, const FGameplayTagContainer& AbilityTags, TArray<FSigilAbilityAction>& Actions) const;
	...
	TArray<FSigilAbilityActionSet> ActionSets;
