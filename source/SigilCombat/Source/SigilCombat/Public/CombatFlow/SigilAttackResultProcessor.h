...
#include "SigilAttackResult.h"
#include "UObject/Object.h"
#include "SigilAttackResultProcessor.generated.h"
...
class SIGILCOMBAT_API USigilAttackResultProcessor : public UObject
{
	GENERATED_BODY()
...
public:
	...
	virtual void ProcessIncomingAttackResult(const FSigilAttackResult& AttackResult);
...
protected:
	...
	void HandleIncomingAttackResult(const FSigilAttackResult& AttackResult) const;
	virtual void HandleIncomingAttackResult_Implementation(const FSigilAttackResult& AttackResult) const;
 ...
 */
UCLASS(Abstract)
class SIGILCOMBAT_API USigilAttackResultProcessor_WithTagRequirement : public USigilAttackResultProcessor
{
	GENERATED_BODY()
...
public:
	 ...
	 * @param AttackResult The attack result to process. 要处理的攻击结果。
	 */
	virtual void ProcessIncomingAttackResult(const FSigilAttackResult& AttackResult) override;
 ...
 */
UCLASS()
class SIGILCOMBAT_API USigilAttackResultProcessor_GameplayEvent : public USigilAttackResultProcessor_WithTagRequirement
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SIGILCOMBAT_API USigilAttackResultProcessor_GameplayCue : public USigilAttackResultProcessor
{
	GENERATED_BODY()
