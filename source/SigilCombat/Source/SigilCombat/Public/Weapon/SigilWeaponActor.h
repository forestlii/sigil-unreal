 ...
 * 武器激活状态更改的委托。
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FSigilWeaponActiveStateChangedSignature, bool, bIsActive);
...
protected:
	...
	void OnAnyTraceHit(USigilCollisionTraceInstance* TraceInstance, const FHitResult& HitResult);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category="GCS|WeaponTrace")
	void OnAnyTraceStateChanged(USigilCollisionTraceInstance* TraceInstance, bool NewState);
	...
	FSigilWeaponActiveStateChangedSignature OnWeaponActiveStateChangedEvent;
