...
#include "SigilWeaponInterface.generated.h"
 ...
 */
UINTERFACE()
class USigilWeaponInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 武器相关功能的接口。
 */
class SIGILCOMBAT_API ISigilWeaponInterface
{
	GENERATED_BODY()
...
public:
	...
	FTransform SigilGetTargetingStartTransform() const;
	...
	void SigilToggleTargeting(bool bEnable);
};