...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SigilAnimNode_CurvesBlend)

void FSigilAnimNode_CurvesBlend::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FSigilAnimNode_CurvesBlend::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_FUNC()
...
void FSigilAnimNode_CurvesBlend::Update_AnyThread(const FAnimationUpdateContext& Context)
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_FUNC()
	...
	TRACE_ANIM_NODE_VALUE(Context, TEXT("Blend Mode"), *StaticEnum<ESigilCurvesBlendMode>()->GetNameStringByValue(static_cast<int64>(GetBlendMode())));
}

void FSigilAnimNode_CurvesBlend::Evaluate_AnyThread(FPoseContext& Output)
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_FUNC()
...
float FSigilAnimNode_CurvesBlend::GetBlendAmount() const
{
	return GET_ANIM_NODE_DATA(float, BlendAmount);
}

ESigilCurvesBlendMode FSigilAnimNode_CurvesBlend::GetBlendMode() const
{
	return GET_ANIM_NODE_DATA(ESigilCurvesBlendMode, BlendMode);
}
