...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SigilAnimNode_LayeredBoneBlend)

/////////////////////////////////////////////////////
// FSigilAnimNode_LayeredBoneBlend

void FSigilAnimNode_LayeredBoneBlend::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FSigilAnimNode_LayeredBoneBlend::RebuildPerBoneBlendWeights(const USkeleton* InSkeleton)
{
	if (InSkeleton)
	{
...
bool FSigilAnimNode_LayeredBoneBlend::ArePerBoneBlendWeightsValid(const USkeleton* InSkeleton) const
{
	return (InSkeleton != nullptr && InSkeleton->GetGuid() == SkeletonGuid && InSkeleton->GetVirtualBoneGuid() == VirtualBoneGuid);
}

void FSigilAnimNode_LayeredBoneBlend::UpdateCachedBoneData(const FBoneContainer& RequiredBones, const USkeleton* Skeleton)
{
...
void FSigilAnimNode_LayeredBoneBlend::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
...
void FSigilAnimNode_LayeredBoneBlend::Update_AnyThread(const FAnimationUpdateContext& Context)
{
...
void FSigilAnimNode_LayeredBoneBlend::Evaluate_AnyThread(FPoseContext& Output)
{
...
void FSigilAnimNode_LayeredBoneBlend::GatherDebugData(FNodeDebugData& DebugData)
{
