...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SigilAnimNode_OrientationWarping)
...
void FSigilAnimNode_OrientationWarping::GatherDebugData(FNodeDebugData& DebugData)
{
...
void FSigilAnimNode_OrientationWarping::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FSigilAnimNode_OrientationWarping::UpdateInternal(const FAnimationUpdateContext& Context)
{
...
void FSigilAnimNode_OrientationWarping::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
{
...
bool FSigilAnimNode_OrientationWarping::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones)
{
#if ENABLE_ANIM_DEBUG
...
void FSigilAnimNode_OrientationWarping::InitializeBoneReferences(const FBoneContainer& RequiredBones)
{
...
void FSigilAnimNode_OrientationWarping::Reset(const FAnimationBaseContext& Context)
{
	bIsFirstUpdate = true;
