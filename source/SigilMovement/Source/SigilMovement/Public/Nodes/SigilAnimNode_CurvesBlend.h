...
#include "SigilAnimNode_CurvesBlend.generated.h"

UENUM(BlueprintType)
enum class ESigilCurvesBlendMode : uint8
{
...
struct SIGILMOVEMENT_API FSigilAnimNode_CurvesBlend : public FAnimNode_Base
{
	GENERATED_BODY()
...
public:
	...
	ESigilCurvesBlendMode BlendMode{ESigilCurvesBlendMode::BlendByAmount};
#endif
...
public:
	...
	ESigilCurvesBlendMode GetBlendMode() const;
};
