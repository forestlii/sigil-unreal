...
#include "SigilAnimNode_OrientationWarping.generated.h"
...
struct SIGILMOVEMENT_API FSigilAnimNode_OrientationWarping : public FAnimNode_SkeletalControlBase
{
	GENERATED_BODY()
	...
	FSigilOrientationWarpingBoneReference ExternalBoneReference;
