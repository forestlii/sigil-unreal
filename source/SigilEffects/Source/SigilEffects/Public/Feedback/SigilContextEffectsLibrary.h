...
#include "SigilContextEffectsLibrary.generated.h"
...
class SIGILEFFECTS_API USigilActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
DECLARE_DYNAMIC_DELEGATE_OneParam(FSigilContextEffectLibraryLoadingComplete, TArray<USigilActiveContextEffects *>, ActiveContextEffects);
...
class SIGILEFFECTS_API USigilContextEffectsLibrary : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	TArray<FSigilContextEffects> ContextEffects;
	 ...
	 */
	ESigilContextEffectsLibraryLoadState GetContextEffectsLibraryLoadState();
...
private:
	 ...
	 */
	void OnContextEffectLibraryLoadingComplete(TArray<USigilActiveContextEffects*> InActiveContextEffects);
	 ...
	 */
	UPROPERTY(Transient)
	TArray<TObjectPtr<USigilActiveContextEffects>> ActiveContextEffects;
	 ...
	 */
	UPROPERTY(Transient)
	ESigilContextEffectsLibraryLoadState EffectsLoadState = ESigilContextEffectsLibraryLoadState::Unloaded;
