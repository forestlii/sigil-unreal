...
#include "SigilContextEffectsSubsystem.generated.h"

class USigilContextEffectsPreviewSetting;
enum EPhysicalSurface : int;

class AActor;
class UAudioComponent;
class USigilContextEffectsLibrary;
...
class SIGILEFFECTS_API USigilContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	TSoftObjectPtr<USigilContextEffectsPreviewSetting> PreviewSetting;
#endif
};
 ...
 */
UCLASS()
class SIGILEFFECTS_API USigilContextEffectsSet : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UPROPERTY(Transient)
	TSet<TObjectPtr<USigilContextEffectsLibrary>> ContextEffectsLibraries;
};
 ...
 */
UCLASS()
class SIGILEFFECTS_API USigilContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
public:
	...
	void SpawnContextEffects(UObject* WorldContextObject, TSoftObjectPtr<USigilContextEffectsLibrary> EffectsLibrary, FSigilSpawnContextEffectsInput Input, FSigilSpawnContextEffectsOutput& Output);
	...
	void SpawnContextEffectsExt(const AActor* SpawningActor, const FSigilSpawnContextEffectsInput& Input, FSigilSpawnContextEffectsOutput& Output);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GES|ContextEffects")
	void LoadAndAddContextEffectsLibraries(AActor* OwningActor, TSet<TSoftObjectPtr<USigilContextEffectsLibrary>> ContextEffectsLibraries);
...
private:
	 ...
	 */
	UPROPERTY(Transient)
	TMap<TObjectPtr<AActor>, TObjectPtr<USigilContextEffectsSet>> ActiveActorEffectsMap;
};