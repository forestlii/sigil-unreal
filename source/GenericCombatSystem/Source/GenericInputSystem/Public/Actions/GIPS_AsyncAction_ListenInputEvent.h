...
public:
	...
	static UGIPS_AsyncAction_ListenInputEvent* ListenInputEvent(UObject* WorldContextObject, UGIPS_InputSystemComponent* InputSystemComponent, FGameplayTagContainer InputTagsToListen,
