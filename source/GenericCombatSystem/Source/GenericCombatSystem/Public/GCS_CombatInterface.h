...
#include "GCS_CombatInterface.generated.h"
...
class UGCS_CombatInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * @注意 实现对象应分组相关功能。
 */
class GENERICCOMBATSYSTEM_API IGCS_CombatInterface
{
	GENERATED_BODY()
...
public:
	...
	UObject* GCS_GetWeapon(UObject* Context) const;
	...
	bool GCS_GetRelativeTransformToSocket(const USkeletalMeshComponent* InSkeletalMeshComponent, const UStaticMesh* StaticMesh, const USkeletalMesh* SkeletalMesh, FName SocketName,
