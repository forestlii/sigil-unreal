 ...
 */
USTRUCT(BlueprintType)
struct GENERICCOMBATSYSTEM_API FGCS_UserSetting
{
	GENERATED_BODY()
};
 ...
 */
USTRUCT(BlueprintType)
struct FGCS_UserSetting_Attributes : public FGCS_UserSetting
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct GENERICCOMBATSYSTEM_API FGCS_CollisionTraceDefinition
{
	GENERATED_BODY()
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCS")
	TSoftClassPtr<UGCS_CollisionTraceInstance> TraceClass;
