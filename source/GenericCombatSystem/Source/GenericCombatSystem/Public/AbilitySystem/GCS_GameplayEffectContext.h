 ...
 */
USTRUCT()
struct GENERICCOMBATSYSTEM_API FGCS_GameplayEffectContext : public FGameplayEffectContext
{
	GENERATED_BODY()
...
/**
 * Struct traits for FGCS_GameplayEffectContext.
 * FGCS_GameplayEffectContext的结构特性。
 */
template <>
struct TStructOpsTypeTraits<FGCS_GameplayEffectContext> : TStructOpsTypeTraitsBase2<FGCS_GameplayEffectContext>
{
	enum
	{
...
struct GENERICCOMBATSYSTEM_API FGCS_GameplayEffectContext_Payload
{
	GENERATED_BODY()
	 ...
	 * 攻击定义数据表。
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCS", meta=(RowType="/Script/GenericCombatSystem.GCS_AttackDefinition"))
	TObjectPtr<const UDataTable> AtkDataTable{nullptr};
