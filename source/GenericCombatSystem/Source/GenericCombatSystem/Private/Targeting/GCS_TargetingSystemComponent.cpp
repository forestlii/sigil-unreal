...
void UGCS_TargetingSystemComponent::OnRefreshAssassination_Implementation()
{
...
void UGCS_TargetingSystemComponent::AddAssassinationListen()
{
	CheckAssassinationTargetRefCount = CheckAssassinationTargetRefCount + 1;
}

void UGCS_TargetingSystemComponent::RemoveAssassinationListen()
{
	CheckAssassinationTargetRefCount = CheckAssassinationTargetRefCount - 1;
	if (CheckAssassinationTargetRefCount < 0) CheckAssassinationTargetRefCount = 0;
}

bool UGCS_TargetingSystemComponent::CheckAssassination() const
{
