...
#include "SigilCameraMode.generated.h"
...
/**
 * ESigilCameraModeBlendFunction
 *
 *	Blend function used for transitioning between camera modes.
 */
UENUM(BlueprintType)
enum class ESigilCameraModeBlendFunction : uint8
{
...
struct SIGILCAMERA_API FSigilCameraModeView
{
public:
	GENERATED_BODY()

	FSigilCameraModeView();

	void Blend(const FSigilCameraModeView& Other, float OtherWeight);
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCMS")
	FVector SpringArmSocketOffset{ForceInit};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCMS")
	FVector SpringArmTargetOffset{ForceInit};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCMS")
	float SpringArmLength{ForceInit};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="GCMS")
...
class SIGILCAMERA_API USigilCameraMode : public UObject
{
	GENERATED_BODY()
...
public:
	...
	const FSigilCameraModeView& GetCameraModeView() const { return View; }
...
protected:
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, Category = "Blending")
	ESigilCameraModeBlendFunction BlendFunction;
