...
#include "SigilInputSystemComponent.generated.h"

class USigilInputControlSetup;
...
class SIGILINPUT_API USigilInputSystemComponent : public UActorComponent
{
	GENERATED_BODY()

	friend USigilInputControlSetup;

public:
	enum class ESigilOwnerType:uint8
	{
		Pawn,
		PC,
	};
...
public:
	USigilInputSystemComponent(const FObjectInitializer& ObjectInitializer);
	...
	static USigilInputSystemComponent* GetInputSystemComponent(const AActor* Actor);
	...
	static bool FindInputSystemComponent(const AActor* Actor, USigilInputSystemComponent*& Component);
	...
	FSigilInputComponentSignature SetupInputComponentEvent;
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category="GIPS|Input")
	FSigilInputComponentSignature CleanupInputComponentEvent;
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category="GIPS|Input")
	FSigilInputBufferWindowStateChangedSignature InputBufferWindowStateChangedEvent;
...
protected:
	 ...
	 */
	ESigilOwnerType OwnerType = ESigilOwnerType::PC;
...
protected:
	...
	TArray<TObjectPtr<USigilInputControlSetup>> InputControlSetups;
...
#pragma region InputControl
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="GIPS|Input")
	USigilInputControlSetup* GetCurrentInputSetup() const;
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="GIPS|Input")
	USigilInputConfig* GetInputConfig() const;
	...
	virtual void PushInputSetup(USigilInputControlSetup* NewSetup);
...
#pragma region InputTag
	...
	virtual bool CheckInputAllowed(UPARAM(meta = (Categories="InputTag,Sigil.Input.InputTag")) FGameplayTag InputTag, ETriggerEvent TriggerEvent);
	...
	virtual bool CheckInputAllowed(const FInputActionInstance& ActionData, UPARAM(meta = (Categories="InputTag,Sigil.Input.InputTag")) FGameplayTag InputTag, ETriggerEvent TriggerEvent);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GIPS|Input")
	UInputAction* GetInputActionOfInputTag(UPARAM(meta = (Categories="InputTag,Sigil.Input.InputTag")) FGameplayTag InputTag) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GIPS|Input")
	FInputActionValue GetInputActionValueOfInputTag(UPARAM(meta = (Categories="InputTag,Sigil.Input.InputTag")) FGameplayTag InputTag) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GIPS|Input")
	FInputActionValue GetLastInputActionValueOfInputTag(UPARAM(meta = (Categories="InputTag,Sigil.Input.InputTag")) FGameplayTag InputTag) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GIPS|Input")
	TArray<FSigilBufferedInput> GetPassedInputEntries() const { return PassedInputEntries; };
	 ...
	 */
	virtual void RegisterPassedInputEntry(const FSigilBufferedInput& InputEntry);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GIPS|Input")
	TArray<FSigilBufferedInput> GetBlockedInputEntries() const { return BlockedInputEntries; };
	 ...
	 * @param InputEntry The input entry to register. 要注册的输入记录。
	 */
	virtual void RegisterBlockedInputEntry(const FSigilBufferedInput& InputEntry);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="GIPS|Input")
	TArray<FSigilBufferedInput> GetBufferedInputEntries() const { return BufferedInputEntries; };
	 ...
	 * @param InputEntry The input entry to register. 要注册的输入记录。
	 */
	virtual void RegisterBufferedInputEntry(const FSigilBufferedInput& InputEntry);
...
protected:
	...
	TArray<FSigilBufferedInput> PassedInputEntries;
	 ...
	 */
	UPROPERTY(VisibleAnywhere, Category="GIPS|Input")
	TArray<FSigilBufferedInput> BlockedInputEntries;
	 ...
	 */
	UPROPERTY(VisibleAnywhere, Category="GIPS|Input")
	TArray<FSigilBufferedInput> BufferedInputEntries;
...
public:
	 ...
	 */
	UPROPERTY(BlueprintAssignable)
	FSigilReceivedInputSignature OnFireBufferedInput;
	...
	FSigilBufferedInput GetLastBufferedInput() const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="GIPS|InputBuffer")
	TMap<FGameplayTag, FSigilBufferedInput> GetActiveBufferWindows() const;
...
protected:
	...
	TMap<FGameplayTag, FSigilBufferedInput> ActiveBufferWindows;
	...
	FSigilBufferedInput LastBufferedInput;
	 ...
	 */
	UPROPERTY()
	FSigilBufferedInput CurrentBufferedInput;
