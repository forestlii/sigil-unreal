...
public:
	...
	//~IGIS_EquipmentInterface interface
	/**
	...
	//~End of IGIS_EquipmentInterface interface
...
#pragma region Equipment Actors
	...
	// bool K2_SpawnEquipmentActors(const TArray<FGIS_EquipmentActorToSpawn>& ActorsToSpawn, TArray<AActor*>& OutActors) const;
